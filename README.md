...
2. The Python 2.7 program needs 5 command line arguments.
	1. input-file - ./log_input/log.txt
	2. out-file1 - ./log_output/hosts.txt
	3. out-file2 - ./log_output/resources.txt
	4. out-file3 - ./log_output/hours.txt
	5. out-file4 - ./log_output/blocked.txt
